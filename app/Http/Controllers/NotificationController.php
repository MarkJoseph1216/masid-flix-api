...
class NotificationController extends Controller
{
    ...
    {
        try {
            $debug['steps'][] = 'Using hardcoded credentials for testing...';
            ...
            $debug['steps'][] = 'Credentials hardcoded with private key length: ' . strlen($credentials['private_key']);
            
            $client = new \Google\Client();
            $client->setAuthConfig($credentials);
            $client->addScope('https://www.googleapis.com/auth/firebase.messaging');
            
            $debug['steps'][] = 'Google Client configured with hardcoded credentials';
            ...
            $debug['steps'][] = 'Access token obtained successfully with hardcoded credentials';
